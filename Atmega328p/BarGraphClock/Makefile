...
SRC=main.c ../Libraries/IIC/IIC.c ../Libraries/Timer0/Timer0.c ../Libraries/DS1307/DS1307.c ../Libraries/ShiftOut/ShiftOut.c#C source files, including files in other folders, "library" method suported
